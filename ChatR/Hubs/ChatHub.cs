...
namespace ChatR.Hubs
{
    public class ChatHub : Hub
    {
        ...
        public void BroadcastLine(float oldX, float oldY, float newX, float newY)
        {

            Clients.Group(getRoomname()).drawLine(oldX, oldY, newX, newY);
        }
        public void BroadcastPoint(string x, string y)
        {
